...
<html>
    <head>
        ...
        <script src="<?php echo base_asset(); ?>Library/bootstrap-4.1.1-dist/js/bootstrap.js"></script>
            ...
            <div class="row" style="height: 100%" >
                <div class="col-3 bg-dark ">
                    <div class="list-group">
                        <a href="<?php echo base_url_admin('view_data'); ?>" class="list-group-item list-group-item-action">Lihat Data</a>
                        <a href="<?php echo base_url_admin('add_data'); ?>" class="list-group-item list-group-item-action">Tambah Data</a>
                        <a href="<?php echo base_url_admin('edit_home'); ?>" class="list-group-item list-group-item-action">Edit Home</a>
                        <a href="<?php echo base_url_admin('login/logout'); ?>" class="list-group-item list-group-item-action">Logout</a>
                    </div>
                </div>
